...
export class CreateTables1636752949913 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "notaFiscal" ("idNotaFiscal" SERIAL NOT NULL, "idHospede" integer NOT NULL, "dataEmissao" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bbe5b54bf0f2210d5e370f9142e" PRIMARY KEY ("idNotaFiscal"))`);
